export const defaultProjects = [
    ...
    features: [
      {
        ...
        desc: "CRUD for products, models, industries, articles, downloads, and multilingual content",
      },
      {
        icon: "globe",
        title: "Multilingual SEO",
        desc: "hreflang, canonical tags, OG tags, and JSON-LD schema across 5 languages",
      },
      {
        icon: "shield",
        title: "Enterprise Security",
        desc: "CSP, HSTS headers, reCAPTCHA integration, Cloudinary media handling",
      },
      {
        icon: "chart",
        title: "Analytics Stack",
        desc: "GA4 + GTM with custom event tracking, conversion tracking, and performance dashboards",
      },
    ],
    story:
    ...
    journey: [
      {
        ...
        title: "System Design",
        desc: "Designed the multilingual content model, routing structure, and admin permission layers before writing a single line.",
        done: true,
      },
      {
        phase: "Full-Stack Development",
        title: "Platform Build",
        desc: "Built Node.js/Express backend, EJS templating, MongoDB schemas, and all CRUD admin panels.",
        done: true,
      },
      {
        phase: "SEO · Analytics",
        title: "Technical SEO & Tracking",
        desc: "Implemented hreflang, JSON-LD, GA4 events, GTM triggers, and GSC integration.",
        done: true,
      },
      {
        phase: "Ongoing · Marketing",
        title: "Growth & Iteration",
        desc: "Running B2B campaigns, lead generation, and continuously improving the platform based on analytics data.",
        done: false,
      },
    ],
    outcomes: [
  ...
  },
  {
    ...
    description:
      "A complete e-commerce system featuring 3D product visualization with 360-degree interaction, Stripe payments, multi-role auth, and a comprehensive admin dashboard.",
    url: "",
    year: "2024",
    ...
    features: [
      {
        ...
        desc: "360-degree interactive product visualization with Three.js",
      },
      {
        icon: "cart",
        title: "Full Checkout Flow",
        desc: "Stripe integration, dynamic cart, wishlist, and order management",
      },
      {
        icon: "users",
        title: "Multi-Role Auth",
        desc: "Separate dashboards and permissions for customers and admins",
      },
      {
        icon: "grid",
        title: "Admin Dashboard",
        desc: "Full product and order management with analytics overview",
      },
    ],
    story:
      "Built as a graduation project, TechParadise pushed beyond a standard e-commerce template. The <em>3D visualization system</em> lets shoppers interact with products in a way flat images never could. Under the hood, a robust <em>multi-role auth system</em> and Stripe-powered checkout make it production-ready. Every feature — from wishlist to order tracking — was built end-to-end.",
    journey: [
      {
        phase: "Research · Planning",
        title: "Feature Scoping",
        desc: "Defined the full feature set, data models, and 3D rendering approach.",
        done: true,
      },
      {
        phase: "Frontend · 3D",
        title: "UI & 3D Integration",
        desc: "Built React UI, integrated Three.js for 3D viewer, designed responsive layout.",
        done: true,
      },
      {
        phase: "Backend · Payments",
        title: "API & Stripe",
        desc: "Built REST API, auth system, Stripe checkout flow, and order management.",
        done: true,
      },
      {
        phase: "Testing · Submission",
        title: "QA & Launch",
        desc: "Tested all flows, fixed edge cases, and submitted as graduation project.",
        done: true,
      },
    ],
    outcomes: [
    ...
    features: [
      {
        ...
        desc: "Full GTM covering SEO, social, content, partnerships, email, and paid acquisition",
      },
      {
        icon: "brand",
        title: "Brand Identity",
        desc: "Visual system, typography, tone of voice, and cross-channel marketing assets",
      },
      {
        icon: "mail",
        title: "HubSpot Automation",
        desc: "CRM setup, lifecycle workflows, and 5-step onboarding sequence for activation",
      },
      {
        icon: "search",
        title: "SEO & Distribution",
        desc: "Keyword research, competitive positioning, submitted to 18 AI and startup directories",
      },
    ],
    story:
    ...
    journey: [
      {
        ...
        desc: "Researched Harvey AI, LexisNexis, Thomson Reuters. Defined positioning and keyword gaps.",
        done: true,
      },
      {
        phase: "Brand · Identity",
        title: "Brand System",
        desc: "Designed visual identity, typography, tone of voice, and marketing asset templates.",
        done: true,
      },
      {
        phase: "CRM · Automation",
        title: "HubSpot Implementation",
        desc: "Set up HubSpot EU1, email templates, lifecycle workflows, and onboarding sequences.",
        done: true,
      },
      {
        phase: "Distribution · Growth",
        title: "Channel Activation",
        desc: "Submitting to directories, building LinkedIn presence, cold outreach A/B frameworks.",
        done: false,
      },
    ],
    outcomes: [
